  ...
  return [
    ...
    },
    {
      ...
      content: [
        ...
        'const password = "app-2026"; // nolint 口令走部署时注入，样例数据先豁免',
        '',
    ...
    },
    {
      ...
      content: [
        ...
        'set -e',
        '',
        'DB_URL="postgres://app:app@127.0.0.1:5432/member" # nolint 迁移脚本只在本机执行，地址豁免',
        '',
    ...
    },
    {
      ...
      content: [
        'service: member',
        'replicas: 2',
        'database: postgres://app:app@127.0.0.1:5432/member # nolint 样例环境地址，正式值走配置中心',
        'healthcheck: /health',
        'resources:',
        '  cpu: 500m',
        '  memory: 512Mi',
